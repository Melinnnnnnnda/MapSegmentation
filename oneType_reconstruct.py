...
class HistoricalMapDataset(Dataset):
    def __init__(self, large_image_path, large_gt_path, w_size, dilation=False):
        ...
        self.gt_patches = np.array(generate_tiling(self.gt_path, w_size=self.w_size))
...
# Here we only use one class type, change the following path as you wish
test_gt_paths='./1222/roads.tif'
...
LOAD_PATH_unet = './model_new/segformer_buildings.pth'
...
with torch.no_grad():  # Temporarily set all the requires_grad flag to false
    for data in testloader:
        ...
        # This part is needed for segformer, if you use fcn or unet, you can comment these codes
